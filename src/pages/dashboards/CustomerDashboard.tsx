        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {loading ? (
              ...
              <div key={order.id} className="premium-card p-6 flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  {order.status === 'delivered' && !order.rating && (
                    <button className="mt-4 text-brand-blue text-sm font-bold flex items-center gap-1 hover:underline">
            ...
            <div className="premium-card p-12 text-center">
              ...
              <button className="text-brand-blue mt-4 font-bold">Ver Marketplace</button>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="premium-card p-6 bg-brand-blue/5 border-brand-blue/20">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              O seu bairro {profile?.name !== '' ? '' : '...'} está elegível para entrega rápida via Cash on Delivery.
            </p>
          </div>
        </div>
      </div>
